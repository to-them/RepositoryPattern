...
{
    [TestClass]
    public class UnitTestStudentServiceMySQL
    {
        StudentServiceMySQL _service = new StudentServiceMySQL();
        bool _result = false;
        private readonly int _readId = 2;
        private readonly int _updateId = 4;
        //private readonly int _deleteId = 5;
